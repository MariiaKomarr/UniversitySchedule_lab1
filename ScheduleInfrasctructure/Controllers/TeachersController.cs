...
namespace ScheduleInfrasctructure.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(lab_1Context context)
        {
            _context = context;
        }
        ...
        {
            var lab_1Context = _context.Teachers.Include(t => t.Department);
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,FullName,DepartmentId,Email,Phone")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeacherId,FullName,DepartmentId,Email,Phone")] Teacher teacher)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'lab_1Context.Teachers'  is null.");
            }
            var teacher = await _context.Teachers.FindAsync(id);
            if (teacher != null)
            {
