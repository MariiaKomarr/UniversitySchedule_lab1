...
namespace ScheduleInfrasctructure.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(lab_1Context context)
        {
            _context = context;
        }
        ...
        {
            var lab_1Context = _context.Users.Include(u => u.Student).Include(u => u.Teacher);
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,Password,Role,TeacherId,StudentId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,UserName,Password,Role,TeacherId,StudentId")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'lab_1Context.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
